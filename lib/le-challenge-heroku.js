            ...
            set: function (args, domain, challengeId, keyAuthorization, callback) {
                ...
                co(
                    function*() {
                        ...
                        debug("The config var LETS_ENCRYPT_CHALLENGE was set to %s", keyAuthorization);
                        debug("Restarting Heroku's dynos...");
                        yield herokuClient.delete('/apps/' + herokuAppId + '/dynos');
                        debug("Heroku's dynos were restarted");
            ...
            remove: function (defaults, domain, challengeId, callback) {
                ...
                co(
                    function*() {
                        ...
                        debug("Config var LETS_ENCRYPT_CHALLENGE was removed");
                    })
                    .catch(callback);
            },
